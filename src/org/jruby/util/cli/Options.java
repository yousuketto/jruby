...
public class Options {
    ...
    public static final Option<Boolean> IR_PERSISTENCE = bool(IR, "ir.persist", false, "Persist generated JRuby IR.");
    public static final Option<Boolean> IR_READING  = bool(IR, "ir.read", false, "Read JRuby IR file.");
    public static final Option<Boolean> IR_PERSISTENCE_PROFILE = bool(IR, "ir.persistence.profiling", false, "Measure time that is required for creation of IR/AST and print it into standard output");
