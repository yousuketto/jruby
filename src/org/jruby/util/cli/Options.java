...
public class Options {
    ...
    public static final Option<Boolean> INVOKEDYNAMIC_INVOCATION_ATTR = bool(INVOKEDYNAMIC, "invokedynamic.invocation.attr", false, "Bind Ruby attribue invocations directly to invokedynamic.");
    ...
    public static final Option<String> COMPAT_VERSION = string(MISCELLANEOUS, "compat.version", new String[]{"1.8","1.9"}, Constants.DEFAULT_RUBY_VERSION, "Specify the major Ruby version to be compatible with.");
