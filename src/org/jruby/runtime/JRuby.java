...
public interface JRuby extends Provider {
    ...
    @FunctionName("org.jruby.runtime.LoadService.require()") void findRequireEntry(String loadedFile, String fileName, int lineNo);
    @FunctionName("org.jruby.runtime.LoadService.autoloadRequire()") void requireEntry(String loadedFile, String fileName, int lineNo);
