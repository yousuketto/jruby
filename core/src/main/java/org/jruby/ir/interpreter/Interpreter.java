        ...
        while (ipc < n) {
            ...
            try {
                ...
                case BRANCH_OP: {
                    ...
                    case B_TRUE_UNBOXED: if (getFloatArg(floats, ((BranchInstr)instr).getArg1()) == 1.0) ipc = ((BranchInstr)instr).getJumpTarget().getTargetPC(); break;
                    case B_FALSE_UNBOXED: if (getFloatArg(floats, ((BranchInstr)instr).getArg1()) == 0.0) ipc = ((BranchInstr)instr).getJumpTarget().getTargetPC(); break;
